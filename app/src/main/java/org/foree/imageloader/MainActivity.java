...
public class MainActivity extends AppCompatActivity {
    ...
    class ImageAdapter extends RecyclerView.Adapter<ImageHolder> {
        ...
        public void onBindViewHolder(ImageHolder holder, int position) {
            MainImageLoader.getInstance().displayImage(holder.imageView, rssItemList.get(position).getImageUrl());
        }
    ...
    private void generateTestData(){
        final String[] imageThumbUrls = new String[] {
                ...
                "http://img.fotomen.cn/2016/08/Leica_Tmall-Store-Opening-Press-Conference_01.jpg",
        };

        rssItemList = new ArrayList<>();

        for(String imageUrl: imageThumbUrls){
            rssItemList.add(new RssItem(imageUrl));
        }
    }
